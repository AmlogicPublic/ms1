...
USB2UARTSPIIICDLL_API int __stdcall UARTRcvData(unsigned char *rcvBuf, int len,unsigned int UsbIndex);
...
USB2UARTSPIIICDLL_API int __stdcall IICRegisterSend(unsigned char addrMod,unsigned int addr,unsigned char *regBuf,unsigned char *sendBuf,unsigned char reglen,unsigned slen,unsigned int UsbIndex);
USB2UARTSPIIICDLL_API int __stdcall IICRegisterRead(unsigned char addrMod,unsigned int addr,unsigned char *regBuf,unsigned char *rcvBuf,unsigned char reglen,unsigned rlen,unsigned int UsbIndex);
USB2UARTSPIIICDLL_API int __stdcall IICDirectSend(unsigned char addrMod,unsigned int addr,unsigned char *sendBuf,unsigned slen,unsigned int UsbIndex);
USB2UARTSPIIICDLL_API int __stdcall IICDirectRead(unsigned char addrMod,unsigned int addr,unsigned char *rcvBuf,unsigned rlen,unsigned int UsbIndex);
