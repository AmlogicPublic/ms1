...
typedef enum IRQn {
    ...
    Reserved16_IRQn           =  18,              /*!<  mip_bwei Bus Write Error Interrupt */
...
#define EXTERNAL_TIMER_A_IRQn                      SOC_EXTERNAL_MAP_TO_ECLIC_IRQn_OFFSET + 32*0 + 0
#define WATCHDOG_IRQn                              SOC_EXTERNAL_MAP_TO_ECLIC_IRQn_OFFSET + 32*0 + 1
#define IR_RX_IRQn                                 SOC_EXTERNAL_MAP_TO_ECLIC_IRQn_OFFSET + 32*0 + 2
#define PWRCTRL_IRQn                               SOC_EXTERNAL_MAP_TO_ECLIC_IRQn_OFFSET + 32*0 + 4
#define UART0_IRQn                                 SOC_EXTERNAL_MAP_TO_ECLIC_IRQn_OFFSET + 32*0 + 5
#define QSPI0_IRQn                                 SOC_EXTERNAL_MAP_TO_ECLIC_IRQn_OFFSET + 32*0 + 6
#define HDMIRX_IRQn                                SOC_EXTERNAL_MAP_TO_ECLIC_IRQn_OFFSET + 32*0 + 10

#define USB_IRQn                                   SOC_EXTERNAL_MAP_TO_ECLIC_IRQn_OFFSET + 32*1 + 2
#define I2C0_IRQn                                  SOC_EXTERNAL_MAP_TO_ECLIC_IRQn_OFFSET + 32*1 + 3
#define I2C1_IRQn                                  SOC_EXTERNAL_MAP_TO_ECLIC_IRQn_OFFSET + 32*1 + 4
#define UART1_IRQn                                 SOC_EXTERNAL_MAP_TO_ECLIC_IRQn_OFFSET + 32*1 + 5
#define QSPI_SG_IRQn                               SOC_EXTERNAL_MAP_TO_ECLIC_IRQn_OFFSET + 32*1 + 6

#define VIDEO_IN0_IRQn                             SOC_EXTERNAL_MAP_TO_ECLIC_IRQn_OFFSET + 32*2 + 0
#define VIDEO_IN1_IRQn                             SOC_EXTERNAL_MAP_TO_ECLIC_IRQn_OFFSET + 32*2 + 1
#define VIDEO_IN2_IRQn                             SOC_EXTERNAL_MAP_TO_ECLIC_IRQn_OFFSET + 32*2 + 2
#define VIDEO_IN3_IRQn                             SOC_EXTERNAL_MAP_TO_ECLIC_IRQn_OFFSET + 32*2 + 3
#define VIDEO_IN4_IRQn                             SOC_EXTERNAL_MAP_TO_ECLIC_IRQn_OFFSET + 32*2 + 4
#define VIDEO_IN5_IRQn                             SOC_EXTERNAL_MAP_TO_ECLIC_IRQn_OFFSET + 32*2 + 5
#define VIDEO_IN6_IRQn                             SOC_EXTERNAL_MAP_TO_ECLIC_IRQn_OFFSET + 32*2 + 6
#define VIDEO_IN7_IRQn                             SOC_EXTERNAL_MAP_TO_ECLIC_IRQn_OFFSET + 32*2 + 7

#define DISP0_IRQn                                 SOC_EXTERNAL_MAP_TO_ECLIC_IRQn_OFFSET + 32*2 + 12
#define DISP1_IRQn                                 SOC_EXTERNAL_MAP_TO_ECLIC_IRQn_OFFSET + 32*2 + 13
#define DISP2_IRQn                                 SOC_EXTERNAL_MAP_TO_ECLIC_IRQn_OFFSET + 32*2 + 14
#define DISP3_IRQn                                 SOC_EXTERNAL_MAP_TO_ECLIC_IRQn_OFFSET + 32*2 + 15
#define DISP4_IRQn                                 SOC_EXTERNAL_MAP_TO_ECLIC_IRQn_OFFSET + 32*2 + 16
#define DISP5_IRQn                                 SOC_EXTERNAL_MAP_TO_ECLIC_IRQn_OFFSET + 32*2 + 17
#define DISP6_IRQn                                 SOC_EXTERNAL_MAP_TO_ECLIC_IRQn_OFFSET + 32*2 + 18

#define VIDEO_OUT0_IRQn                            SOC_EXTERNAL_MAP_TO_ECLIC_IRQn_OFFSET + 32*2 + 20
#define VIDEO_OUT1_IRQn                            SOC_EXTERNAL_MAP_TO_ECLIC_IRQn_OFFSET + 32*2 + 21
#define VIDEO_OUT2_IRQn                            SOC_EXTERNAL_MAP_TO_ECLIC_IRQn_OFFSET + 32*2 + 22
#define VIDEO_OUT3_IRQn                            SOC_EXTERNAL_MAP_TO_ECLIC_IRQn_OFFSET + 32*2 + 23
#define VIDEO_OUT4_IRQn                            SOC_EXTERNAL_MAP_TO_ECLIC_IRQn_OFFSET + 32*2 + 24

#define VGA_IRQn                                   SOC_EXTERNAL_MAP_TO_ECLIC_IRQn_OFFSET + 32*2 + 25
...
// you should use macro __IREGION_BASEADDR defined in soc.h
...
#include <system_soc.h>                         /*!< evalsoc System */
...
#define UART0_BASE              (EVALSOC_PERIPH_BASE + 0x020000)          /*!< (UART0) Base Address */ 
#define UART1_BASE              (EVALSOC_PERIPH_BASE + 0x58E000)          /*!< (UART1) Base Address */ 

#define QSPI0_BASE              (EVALSOC_PERIPH_BASE + 0xB0000)          /*!< (QSPI0) Base Address */
